...
An execution posture for substantial agent work. Wrapper skills (`doctrine-code`, `doctrine-debug`, `doctrine-audit`, `doctrine-docs`) supply the task shape; this skill supplies how the work runs. It layers ON TOP of other skills, notably Matt Pocock's engineering skills: invoke them by name, never fork or restate their content.
